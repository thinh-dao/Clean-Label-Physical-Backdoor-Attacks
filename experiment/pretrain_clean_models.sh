python main.py --devices=2,3 --net=vit_face --model_seed=123456 --poison_seed=123456 --train_from_scratch --save_clean_model --dataset=Facial_recognition_extended --optimization=transformer-adamw --clean_training_only --exp_name=clean_training
python main.py --devices=0,1 --net=resnet50 --model_seed=123456 --poison_seed=123456 --train_from_scratch --save_clean_model --dataset=Facial_recognition_extended --clean_training_only --exp_name=clean_training
