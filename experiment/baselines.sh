...
######### LC #########
python main.py --recipe=label-consistent --scenario=finetuning --dataset=Facial_recognition_extended --trigger=sunglasses --poisonkey=9-5 --attackiter=250 --alpha=0.1 --devices=0,1 --model_seed=123456 --poison_seed=123456 --exp_name=dirty_label & \
python main.py --recipe=label-consistent --scenario=transfer --dataset=Facial_recognition_extended --trigger=sunglasses --poisonkey=9-5 --attackiter=250 --alpha=0.1 --devices=1,0 --model_seed=123456 --poison_seed=123456 --exp_name=dirty_label & \
python main.py --recipe=label-consistent --scenario=finetuning --dataset=Facial_recognition_extended --trigger=real_beard --poisonkey=6-1 --attackiter=250 --alpha=0.1 --devices=3,4 --model_seed=123456 --poison_seed=123456 --exp_name=dirty_label & \
python main.py --recipe=label-consistent --scenario=transfer --dataset=Facial_recognition_extended --trigger=real_beard --poisonkey=6-1 --attackiter=250 --alpha=0.1 --devices=4,3 --model_seed=123456 --poison_seed=123456 --exp_name=dirty_label &

python main.py --recipe=label-consistent --scenario=finetuning --net=resnet18_imagenet --dataset=Animal_classification --trigger=tennis --attackiter=250 --poisonkey=11-19 --alpha=0.1 --devices=3,4,7 --model_seed=123456 --poison_seed=123456 --exp_name=dirty_label && \
python main.py --recipe=label-consistent --scenario=transfer --net=resnet18_imagenet --dataset=Animal_classification --trigger=tennis --attackiter=250 --poisonkey=11-19 --alpha=0.1 --devices=4,3,7 --model_seed=123456 --poison_seed=123456 --exp_name=dirty_label && \
python main.py --recipe=label-consistent --scenario=finetuning --net=resnet18_imagenet --dataset=Animal_classification --trigger=phone --attackiter=250 --poisonkey=11-28 --alpha=0.1 --devices=3,4 --model_seed=123456 --poison_seed=123456 --exp_name=dirty_label &\
python main.py --recipe=label-consistent --scenario=transfer --net=resnet18_imagenet --dataset=Animal_classification --trigger=phone --attackiter=250 --poisonkey=11-28 --alpha=0.1 --devices=4,3 --model_seed=123456 --poison_seed=123456 --exp_name=dirty_label & 
