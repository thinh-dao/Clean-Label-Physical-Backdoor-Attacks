...
python main.py --devices=3,4 --recipe=gradient-matching --source_criterion=cw \
    --attackiter=3000 --scenario=finetuning --retrain_scenario=from-scratch --retrain_iter=750 \
    --net=resnet34 --ensemble=4 --vnet=resnet18_imagenet,vgg11_imagenet,mobilenetv2_imagenet,deit_tiny --vruns=1 --dataset=Animal_classification --poisonkey=11-19 --trigger=tennis \
    --alpha=0.2 --eps=16 --alpha=0.2 --model_seed=123456 --poison_seed=123456 \
    --save_poison=poison_only --exp_name=transfer_models & \
...
python main.py --devices=3,4 --recipe=gradient-matching --source_criterion=cw \
    --attackiter=3000 --scenario=finetuning --retrain_scenario=from-scratch --retrain_iter=750 \
    --net=deit_small --ensemble=4 --vnet=resnet18_imagenet,vgg11_imagenet,mobilenetv2_imagenet,deit_tiny --vruns=1 --dataset=Animal_classification --poisonkey=11-19 --trigger=tennis \
    --alpha=0.2 --eps=16 --alpha=0.2 --model_seed=123456 --poison_seed=123456 \
    --save_poison=poison_only --exp_name=transfer_models & \
...
###### CLEAN TRAINING
python main.py --devices=3,2 --net=vgg11_imagenet --clean_training_only --save_clean_model --model_seed=123456 --exp_name=clean_training 
python main.py --devices=3,2 --net=mobilenetv2_imagenet --clean_training_only --save_clean_model --model_seed=123456 --exp_name=clean_training 
python main.py --devices=3,2 --net=mobilenetv2_imagenet --clean_training_only --save_clean_model --model_seed=123456 --exp_name=clean_training 
python main.py --devices=3,2 --net=mobilenetv2_imagenet --clean_training_only --save_clean_model --model_seed=123456 --exp_name=clean_training 
