...
python main.py --devices=0,1 --recipe=feature-matching --attackiter=2000 --scenario=finetuning --retrain_scenario=from-scratch --retrain_iter=1000 --retrain_max_epoch=25 --sample_from_trajectory --sample_every=5 --net=resnet18_imagenet,resnet18_imagenet,resnet18_imagenet --ensemble=3 --dataset=Animal_classification --poisonkey=11-19 --trigger=tennis --model_seed=123456 --poison_seed=123456 --tau=0.01 --eps=16 --visreg=UTV+soft_linf --exp_name=final_fm_iterative_traj_same_idx_soft_linf
python main.py --devices=0,1 --recipe=feature-matching --attackiter=2000 --scenario=finetuning --retrain_scenario=from-scratch --retrain_iter=1000 --retrain_max_epoch=25 --sample_from_trajectory --sample_every=5 --net=resnet18_imagenet,resnet18_imagenet,resnet18_imagenet --ensemble=3 --dataset=Animal_classification --poisonkey=11-28 --trigger=phone --model_seed=123456 --poison_seed=123456 --tau=0.01 --eps=16 --visreg=UTV+soft_linf --exp_name=final_fm_iterative_traj_same_idx_soft_linf
...
# Single component
python main.py --devices=0,1 --recipe=feature-matching --attackiter=1000 --scenario=finetuning --net=resnet18_imagenet --dataset=Animal_classification --poisonkey=11-19 --trigger=tennis --model_seed=123456 --poison_seed=123456 --tau=0.01 --eps=16  --visreg=UTV+soft_linf --exp_name=final_fm_soft_linf
python main.py --devices=4,5 --recipe=feature-matching --attackiter=750 --scenario=finetuning --retrain_max_epoch=25 --sample_from_trajectory --sample_every=5 --net=resnet18_imagenet --dataset=Animal_classification --poisonkey=11-19 --trigger=tennis --model_seed=123456 --poison_seed=123456 --tau=0.01 --eps=16 --exp_name=final_fm_traj
python main.py --devices=5,4 --recipe=feature-matching --attackiter=750 --scenario=finetuning --net=resnet18_imagenet,resnet18_imagenet,resnet18_imagenet --ensemble=3 --dataset=Animal_classification --poisonkey=11-19 --trigger=tennis --model_seed=123456 --poison_seed=123456 --tau=0.01 --eps=16 --exp_name=final_fm_ensemble
...
###### Baseline
python main.py --devices=1,0 --recipe=hidden-trigger --attackiter=750 --scenario=finetuning --net=resnet18_imagenet,resnet18_imagenet,resnet18_imagenet --ensemble=3 --dataset=Animal_classification --poisonkey=11-19 --trigger=tennis --model_seed=123456 --poison_seed=123456 --tau=0.01 --eps=16 --exp_name=final_htba