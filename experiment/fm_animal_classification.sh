...
python main.py --devices=0,1 --recipe=feature-matching --attackiter=2000 --scenario=finetuning --retrain_scenario=from-scratch --retrain_iter=1000 --retrain_max_epoch=30 --sample_from_trajectory --sample_every=5 --net=resnet18_imagenet --dataset=Animal_classification --poisonkey=11-28 --trigger=phone --model_seed=123456 --poison_seed=123456 --tau=0.01 --eps=24 --exp_name=final_fm_iterative_traj
python main.py --devices=2,3 --recipe=feature-matching --attackiter=2000 --scenario=finetuning --retrain_scenario=from-scratch --retrain_iter=1000 --retrain_max_epoch=30 --net=resnet18_imagenet --dataset=Animal_classification --poisonkey=11-28 --trigger=phone --model_seed=123456 --poison_seed=123456 --tau=0.01 --eps=24 --exp_name=final_fm_iterative
python main.py --devices=4,5 --recipe=feature-matching --attackiter=2000 --scenario=finetuning --step --step_every=200 --net=resnet18_imagenet --dataset=Animal_classification --poisonkey=11-28 --trigger=phone --model_seed=123456 --poison_seed=123456 --tau=0.01 --eps=24 --exp_name=final_fm_iterative_step
