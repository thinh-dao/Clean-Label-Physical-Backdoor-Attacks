...
########################## Ablation study ##########################
python main.py --devices=0,1 --recipe=mttp --attackiter=2000 --scenario=finetuning --retrain_scenario=from-scratch --retrain_iter=1000 --retrain_max_epoch=25 --sample_from_trajectory --sample_every=5 --net=resnet18_imagenet,resnet18_imagenet,resnet18_imagenet --ensemble=3 --dataset=Animal_classification --poisonkey=11-19 --trigger=tennis --model_seed=123456 --poison_seed=123456 --tau=0.1 --eps=16  --visreg=UTV+soft_linf --exp_name=final_mttp_retrain_ensemble_traj_soft_linf
python main.py --devices=1,0 --recipe=mttp --attackiter=1500 --scenario=finetuning --retrain_scenario=from-scratch --retrain_iter=750 --retrain_max_epoch=25 --sample_from_trajectory --sample_every=5 --net=resnet18_imagenet,resnet18_imagenet,resnet18_imagenet --ensemble=3 --dataset=Animal_classification --poisonkey=11-19 --trigger=tennis --model_seed=123456 --poison_seed=123456 --tau=0.1 --eps=16 --exp_name=final_mttp_retrain_ensemble_traj_ensemble
python main.py --devices=2,3 --recipe=mttp --attackiter=1500 --scenario=finetuning --retrain_scenario=from-scratch --retrain_iter=750 --retrain_max_epoch=25 --net=resnet18_imagenet,resnet18_imagenet,resnet18_imagenet --ensemble=3 --dataset=Animal_classification --poisonkey=11-19 --trigger=tennis --model_seed=123456 --poison_seed=123456 --tau=0.1 --eps=16 --exp_name=final_mttp_retrain_ensemble
python main.py --devices=3,2 --recipe=mttp --attackiter=1500 --scenario=finetuning --retrain_scenario=from-scratch --retrain_iter=750 --retrain_max_epoch=25 --net=resnet18_imagenet --dataset=Animal_classification --poisonkey=11-19 --trigger=tennis --model_seed=123456 --poison_seed=123456 --tau=0.1 --eps=16 --exp_name=final_mttp_retrain
python main.py --devices=5,4 --recipe=mttp --attackiter=750 --source_criterion=cw --scenario=finetuning --net=resnet18_imagenet --dataset=Animal_classification --poisonkey=11-19 --trigger=tennis --model_seed=123456 --poison_seed=123456 --tau=0.1 --eps=16 --exp_name=final_mttp_no_retrain_cw
python main.py --devices=4,3 --recipe=mttp --attackiter=750 --scenario=finetuning --net=resnet18_imagenet --dataset=Animal_classification --poisonkey=11-19 --trigger=tennis --model_seed=123456 --poison_seed=123456 --tau=0.1 --eps=16 --exp_name=final_mttp_no_retrain

# Single component
python main.py --devices=3,4 --recipe=mttp --attackiter=1000 --scenario=finetuning --net=resnet18_imagenet --dataset=Animal_classification --poisonkey=11-19 --trigger=tennis --model_seed=123456 --poison_seed=123456 --tau=0.1 --eps=16  --visreg=UTV+soft_linf --exp_name=final_mttp_soft_linf
python main.py --devices=4,5 --recipe=mttp --attackiter=750 --scenario=finetuning --retrain_max_epoch=25 --sample_from_trajectory --sample_every=5 --net=resnet18_imagenet --dataset=Animal_classification --poisonkey=11-19 --trigger=tennis --model_seed=123456 --poison_seed=123456 --tau=0.1 --eps=16 --exp_name=final_mttp_traj
python main.py --devices=5,4 --recipe=mttp --attackiter=750 --scenario=finetuning --net=resnet18_imagenet,resnet18_imagenet,resnet18_imagenet --ensemble=3 --dataset=Animal_classification --poisonkey=11-19 --trigger=tennis --model_seed=123456 --poison_seed=123456 --tau=0.1 --eps=16 --exp_name=final_mttp_ensemble